...
test("api-analytics-test-51", async ({ page }) => {
  ...
  await test.step("Verifying results", async () => {
    ...
    await expect(page.locator('#test-result')).toHaveText(`Test 51 completed successfully`);
  });
});
