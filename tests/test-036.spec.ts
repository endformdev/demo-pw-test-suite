...
test("form-settings-test-36", async ({ page }) => {
  ...
  await test.step("Verifying results", async () => {
    ...
    await expect(page.locator('#test-result')).toHaveText(`Test 36 completed successfully`);
  });
});
