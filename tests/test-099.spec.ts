...
/**
 * Complex component test for profile - variation 1
 * This test is designed to take 20-90 seconds to execute
 */
test("component-profile-test-99", async ({ page }) => {
  // Test scenario 99
  await runComplexTestScenario(page, 99);
  ...
  await test.step("Verifying results", async () => {
    ...
    await expect(page.locator('#test-result')).toHaveText(`Test 99 completed successfully`);
  });
});
