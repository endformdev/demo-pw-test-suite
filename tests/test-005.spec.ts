...
test("navigation-dashboard-test-5", async ({ page }) => {
  ...
  await test.step("Verifying results", async () => {
    ...
    await expect(page.locator('#test-result')).toHaveText(`Test 5 completed successfully`);
  });
});
